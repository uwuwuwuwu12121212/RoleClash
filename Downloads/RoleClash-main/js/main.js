document.addEventListener("DOMContentLoaded", () => {
  ...
  const storyData = [
    ...
    /* 4 */ { title: "大象", content: "我是大象。人們總說大象很強壯、能背負很多東西，也許正因為這樣，我以為自己理所當然要承受這一切。", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 5 */ { title: "大象", content: "一開始，<br>那只是一兩句話。", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 6 */ { title: "大象", content: "「你怎麼還不會？」、「你應該要更努力一點吧？」、<br>「為什麼別人都做得到？」", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 7 */ { title: "大象", content: "我把這些話全收進了心裡。我想要符合大家的期待，我想證明自己可以。但漸漸地，這些聲音變成了具體的形狀，", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 8 */ { title: "大象", content: "它們變成了一個個沉重的對話框，堆疊在我的背上。", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 9 */ { title: "大象", content: "後來，就算別人沒有開口，我也能「聽見」他在批評我，<br>我開始害怕出門，害怕面對別人的眼神。", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 10 */ { title: "大象", content: "我把自己關進一個純黑的空間裡，<br>我以為只要斷絕與外界的接觸，", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    /* 11 */ { title: "大象", content: "只要躲起來，<br>那些聲音就會自己消失。", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    ...
    /* 14 */ { title: "大象", content: "謝謝妳，<br>我想我也該往前走了！再見了！", avatar: "assets/elephant/image/avatar_elephant_fun.png" },
    ...
    /* 26 */ { title: "蒼鷺", content: "就會發現我其實很糟...我一定會搞砸的，<br>我根本...沒有他們想的那麼厲害。」", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 27 */ { title: "蒼鷺", content: "我像是被困在一個沒有出口的高壓艙裡，只能<br>不停地運轉，連停下來喘一口氣都覺得充滿罪惡感。", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 28 */ { title: "蒼鷺", content: "我好累，我的翅膀僵硬得快要斷掉，但...<br>我只能死死盯著那刺眼的光，繼續苛責自己。", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 29 */ { title: "蒼鷺", content: "直到那盞燈關上了...<br>我愣住了，抬起頭看著周圍。沒有人責備我停下筆，", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 30 */ { title: "蒼鷺", content: "沒有人因為燈暗了就離開我。<br>那是一種好安靜、好細緻的陪伴。", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 31 */ { title: "蒼鷺", content: "「原來，我也可以停下來一下。<br>原來，就算我不完美，也有資格好好休息。」", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 32 */ { title: "蒼鷺", content: "謝謝你，<br>我想不完美的我，也有勇氣繼續往前走！", avatar: "assets/bird/image/avatar_bird_fun.png" },
    /* 33 */ { title: "女主角", content: "我們的價值，<br>從來都不需要用燃燒自己來證明。", avatar: "assets/bird/image/avatar_girl_fun.png" },
    /* 34 */ { title: "女主角", content: "我們也可以停下來一下的，<br>對吧？", avatar: "assets/bird/image/avatar_girl_fun.png" },
    /* 35 */ { title: "女主角", content: "遇見他們，<br> 就像撿回了散落在黑暗裡的我自己。", avatar: "assets/bird/image/avatar_girl_fun.png" },
    /* 36 */ { title: "女主角", content: "我們都在這片漆黑的海上漂流，跌跌撞撞地，<br>尋找著那個能讓心靈停泊的彼岸。", avatar: "assets/bird/image/avatar_girl_fun.png" },
    /* 37 */ { title: "女主角", content: "現在，天亮了。<br>我們一起走吧！", avatar: "assets/bird/image/avatar_girl_fun.png" },
    /* 38 */ { title: "遊戲說明", content: "現在，請使用滑鼠滾輪移動，<br>陪伴女主角，一起走向光明！", avatar: "assets/sea/image/avatar_game.png" },
    /* 39*/ { title: "遊戲說明", content: "請用滑鼠點擊留言，<br> 一起分享跟妳一樣迷惘的人吧！", avatar: "assets/sea/image/avatar_game_white.png", theme: "white" }
  ];
